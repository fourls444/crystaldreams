...
function OrderSlipVerificationModal({
  showSlipModal,
  onSetShowSlipModal,
  selectedOrder,
  actionLoading,
      ...
      <div className={styles.modalCard} style={{ maxWidth: "700px" }} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles.modalBody}>
          <div className={styles.slipDetailsGrid}>
               {/* Left Side: Slip image or COD card or not-uploaded state */}
               <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
                {selectedOrder.payment_method === "cod" ? (
                  <>
                    <h4 className={styles.slipInfoTitle}>วิธีการชำระเงิน</h4>
                    <div 
                      className={styles.slipImagePreviewWrapper}
                      style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "1rem", padding: "1.5rem", backgroundColor: "#fffbeb", borderColor: "#fef3c7", textAlign: "center", flexGrow: 1, aspectRatio: "auto" }}
                    >
                      <span style={{ fontSize: "3rem" }}>📦</span>
                      <span style={{ fontWeight: 700, color: "#b45309", fontSize: "1.1rem" }}>เก็บเงินปลายทาง (COD)</span>
                      <span style={{ fontSize: "0.8rem", color: "#d97706", lineHeight: 1.4 }}>
                        ลูกค้าเลือกชำระเงินปลายทางตอนรับสินค้า <br/>
                        ไม่ต้องตรวจสอบสลิปโอนเงินออนไลน์
                      </span>
                    </div>
                  </>
                  ...
                  <>
                    ...
                    <div 
                      ...
                      style={{ cursor: "zoom-in", position: "relative", flexGrow: 1, aspectRatio: "auto", minHeight: "340px" }}
                  ...
                  /* Order is PromptPay but customer hasn't uploaded slip yet */
                  <>
                    <h4 className={styles.slipInfoTitle}>หลักฐานการโอนเงิน (Slip)</h4>
                    <div 
                      className={styles.slipImagePreviewWrapper}
                      style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "1rem", padding: "1.5rem", backgroundColor: "#f8fafc", borderColor: "#e2e8f0", textAlign: "center", flexGrow: 1, aspectRatio: "auto" }}
                    >
                      <span style={{ fontSize: "3rem" }}>📄</span>
                      <span style={{ fontWeight: 700, color: "#475569", fontSize: "1rem" }}>ยังไม่ได้อัปโหลดสลิปโอนเงิน</span>
                      <span style={{ fontSize: "0.8rem", color: "#94a3b8", lineHeight: 1.5 }}>
                        ลูกค้ายังไม่ได้แนบหลักฐานการชำระเงิน<br/>
                        สตัสอร์ด: <strong style={{ color: "#475569" }}>รอชำระเงิน</strong>
                      </span>
                    </div>
                  </>
                )}
            ...
            <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
              <h4 className={styles.slipInfoTitle}>รายละเอียดคำสั่งซื้อ</h4>
              <div className={styles.slipInfoList} style={{ flexGrow: 1 }}>
...
export default memo(OrderSlipVerificationModal);
