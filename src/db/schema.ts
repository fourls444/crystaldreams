...
export const orders = pgTable("orders", {
  ...
  shipping_status: text("shipping_status").notNull().default("processing"),
  ...
  beam_charge_id: text("beam_charge_id").unique(),
  beam_charge_status: text("beam_charge_status"),
  beam_failure_code: text("beam_failure_code"),
